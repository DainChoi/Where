 ...
 */
public class GroupPersonAdapter extends RecyclerView.Adapter<GroupPersonAdapter.MyViewHolder> {

    private static final String TAG = "GroupPersonAdapter";
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View v1 = inflater1.inflate(R.layout.group_list_view, viewGroup, false);
